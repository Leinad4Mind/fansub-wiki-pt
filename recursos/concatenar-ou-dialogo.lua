...
script_name  =  "Concatenar (quebra de linha) / Criar diálogo"
script_description  =  "Concatena duas linhas com \\N (quebra de linha) / Cria um diálogo a partir de duas linhas adicionado –"
...
aegisub.register_macro("Concatenar-Diálogo/Concatenar com \\N", "Concatenar linhas com \\N", concatenate_n, can_join)
aegisub.register_macro("Concatenar-Diálogo/Criar Diálogo", "Criar diálogos com –", create_dialogue, can_join)
